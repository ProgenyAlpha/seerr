...
// Certification list a discover query should be restricted to, or
// undefined when no query-side filter applies. An unrecognized
// maxRating collapses to the most restrictive rating.
